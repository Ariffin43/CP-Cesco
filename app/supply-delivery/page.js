...
export default function supplyDelivery() {
  const services = [
    {
      title: "Equipment & Spare Parts for HMH’s Product",
      img: "/sd/1.png",
      href: "/supply-delivery/FM",
    },
  ];
        ...
        <div className="relative z-10 text-center text-white px-4">
          <nav aria-label="Breadcrumb" className="mb-4">
            <ol className="flex items-center justify-center gap-2 text-sm text-white/80">
              ...
              <li className="font-medium text-white">Supply & Delivery</li>
            </ol>
          </nav>
          ...
          <h1 className="mt-4 text-4xl md:text-5xl font-bold">
            <span className="text-green-400">Supply</span> & <span className="text-green-400">Delivery</span>
          </h1>
